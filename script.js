  ...
  const projects = [
    {
      ...
      description: "Современное SPA-портфолио для демонстрации навыков и проектов",
    ...
    },
    {
      ...
      description: "Адаптивная страница для логистической компании",
    ...
    },
    {
      ...
      description: "Прототип интернет-магазина с базовой логикой",
...
function createGitHubCard() {
    ...
    <a href="https://github.com/orlioglodenis24" target="_blank" rel="noopener noreferrer" class="project-card github-project-card">
      <div class="github-card-wrapper">
        ...
        <div class="github-content">
          ...
          <p class="project-description">Полный код и документация в моём GitHub</p>
          <div class="project-tech">
  ...
  document.getElementById('contactForm').addEventListener('submit', (e) => {
    ...
    const message = `Новая заявка:%0AИмя: ${encodeURIComponent(name)}%0AКонтакт: ${encodeURIComponent(email)}%0AПроект: ${encodeURIComponent(project)}`;
